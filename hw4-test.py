...
class tester_most_common_char(unittest.TestCase):
    ...
    def test__given(self):
        self.assertEqual(most_common_char(
            'AVX is a feature in modern CPUs that allows one instruction to affect multiple units. vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvectors'),
                         'v')
